...
[헤르메스 커스텀 메모리 프로바이더 — 전체 사양](https://www.notion.so/SOURCE_DOC_ID?pvs=21) §8-4 전 범위 (B·C·D 정책)
...
- 완성형 초안은 [Hermes Memory Provider — 필요 메타문서 체크리스트](https://www.notion.so/Hermes-Memory-Provider-SOURCE_DOC_ID?pvs=21)의 각 항목 요구사항을 전부 충족해야 함
